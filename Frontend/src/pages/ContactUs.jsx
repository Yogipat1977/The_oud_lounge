        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <Card className="bg-gray-900 border-gray-800">
              <CardHeader>
                <CardTitle className="text-2xl text-yellow-500"  style={{ fontFamily: "'item'" }}>Send us a Message</CardTitle>
              </CardHeader>
            ...
            <div className="space-y-8">
              <div>
                <h3 className="text-2xl font-bold text-yellow-500 mb-6" style={{ fontFamily: "'item'" }}>Contact Information</h3>
                <p className="text-gray-300 mb-8" style={{ fontFamily: "'item'" }}>
