...
import { Star, Heart, ShoppingCart, Sparkles, Zap, Crown } from "lucide-react"
...
const PromotionalBanner = () => {
  ...
  return (
    <motion.div
      ...
      className="relative bg-gradient-to-r from-yellow-400 to-yellow-500 text-white p-0 mb-12 mx-4 overflow-hidden rounded-3xl shadow-2xl"
      style={{ minHeight: "300px" }}
    >
      {/* Curved organic shape divider */}
      <div className="absolute inset-0">
        <div className="w-full h-full relative">
          {/* Yellow section */}
          <div className="absolute left-0 top-0 w-2/5 h-full bg-gradient-to-br from-yellow-400 to-yellow-500"></div>

          {/* Dark blue section with organic curve */}
          <div
            className="absolute right-0 top-0 h-full bg-gradient-to-br from-slate-700 to-slate-800"
            style={{
              width: "70%",
          ...
          {/* Organic curved overlay */}
          <div
            className="absolute top-0 h-full bg-gradient-to-br from-slate-700 to-slate-800"
            style={{
              left: "35%",
              width: "65%",
      ...
      <div className="absolute bottom-8 left-8 w-12 h-12 bg-slate-700 rounded-full opacity-80"></div>

      {/* Content */}
      <div className="relative z-10 flex items-center h-full min-h-[300px] px-8 py-8">
        <div className="w-full">
          {/* Right side content */}
          <div className="ml-auto max-w-2xl text-right" style={{ marginLeft: "45%" }}>
            <motion.h2
              initial={{ opacity: 0, x: 50 }}
              animate={{ opacity: 1, x: 0 }}
              transition={{ duration: 0.6, delay: 0.2 }}
              className="text-4xl md:text-6xl font-black text-white mb-6 tracking-wider uppercase leading-tight"
            ...
            <motion.div
              ...
              className="h-2 bg-yellow-400 mb-8 ml-auto"
            ></motion.div>
            ...
            <motion.div
              ...
              className="mb-8"
            >
              <p className="text-lg md:text-xl text-gray-200 mb-4 leading-relaxed font-medium tracking-wide">
                BUY ANY 3 PERFUMES FOR £100 AND GET 2 FREE ROLL-INS WORTH £20. MIX AND MATCH ANY FRAGRANCES FROM OUR
                PREMIUM COLLECTION.
              </p>
              <p className="text-base text-yellow-300 font-bold tracking-wide uppercase">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="border-2 border-yellow-400 text-yellow-400 px-8 py-3 font-bold tracking-widest uppercase hover:bg-yellow-400 hover:text-slate-800 transition-all duration-300"
              style={{ fontFamily: "Arial Black, sans-serif" }}
            >
              SHOP NOW
            </motion.button>
