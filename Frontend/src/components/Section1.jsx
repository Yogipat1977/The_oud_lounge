...
export default function WhyChooseUs() {
  return (
    <section className="w-full py-16 bg-gradient-to-br from-amber-50 via-gray-100 to-amber-50 h-[100vh]">
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center mb-12">
          <h2 className="text-4xl md:text-5xl font-bold mb-4 bg-gradient-to-r from-amber-500 via-gray-400 to-amber-500 bg-clip-text text-transparent">
            Why Choose us?
          </h2>
        </div>
